...
This module centralizes all hyperparameters and paths so they can be
overridden from the command line (via argparse in the scripts) while
still providing sensible defaults for quick experimentation.
...
BATCH_SIZE = 128
NUM_WORKERS = 2  # parallel data loading — speeds things up on multi-core machines
